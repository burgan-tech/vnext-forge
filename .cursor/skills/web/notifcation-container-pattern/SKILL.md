...
description: Scope is apps/web (web frontend). Optional guidance for transient user feedback in the web app. Use only when a notification system is intentionally introduced; notifications are not a core architecture requirement of the current refactor. Trigger this skill for any notification/toast work under `apps/web`.
---
