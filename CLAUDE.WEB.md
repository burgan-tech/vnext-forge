...
> **Scope:** `apps/web` (web frontend). Load this file in addition to the repo-wide [`./CLAUDE.md`](./CLAUDE.md) whenever editing code under `apps/web`. Related skills live under `.cursor/skills/` with `Scope: apps/web` in their frontmatter.
...
The detailed architecture rules live in `.cursor/skills/architectural-pattern/SKILL.md` (scope: `apps/web`). Keep this file shorter and more operational.
