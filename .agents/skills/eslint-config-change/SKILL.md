...
description: Update the monorepo ESLint configuration in vnext-forge. Use when changing shared lint rules, workspace-specific ESLint behavior, runtime globals, or logger/no-console overrides.
---
