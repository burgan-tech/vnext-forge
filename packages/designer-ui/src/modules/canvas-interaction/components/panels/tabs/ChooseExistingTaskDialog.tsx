...
import type { DiscoveredVnextComponent, VnextExportCategory } from '@vnext-forge/app-contracts';
...
export function ChooseExistingVnextComponentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        variant="secondary"
        className="border-border bg-surface text-foreground max-h-[min(88vh,600px)] max-w-md gap-0 p-0 shadow-sm"
        showCloseButton
