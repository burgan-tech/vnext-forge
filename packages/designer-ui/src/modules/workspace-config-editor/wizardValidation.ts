...
/**
 * Form değerlerini kayıt / doğrulama ile aynı şekilde normalize eder
 * (satır listeleri sıkıştırılır).
 */
export function normalizeVnextWizardPayload(
  values: VnextWorkspaceConfig,
...
/**
 * Kod editöründen kaydedilen ham metin için sihirbaz ile aynı sıkı kurallar
 * (sunucu şeması daha gevşek olabilir).
 */
