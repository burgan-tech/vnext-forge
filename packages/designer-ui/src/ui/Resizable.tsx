  ...
  return (
    <Separator
      ...
      className={cn(
        ...
        'aria-[orientation=horizontal]:min-w-0 aria-[orientation=horizontal]:w-full aria-[orientation=horizontal]:max-w-full',
        "before:content-[''] before:pointer-events-none before:absolute before:z-[1] before:bg-border",
        ...
        // Dikey ayırıcı (yatay panel grubu): ince çizgi solda — `before:w-px` sadece burada.
        'aria-[orientation=vertical]:before:top-0 aria-[orientation=vertical]:before:bottom-0 aria-[orientation=vertical]:before:left-0 aria-[orientation=vertical]:before:w-px aria-[orientation=vertical]:before:translate-x-0',
        // Yatay ayırıcı (dikey panel grubu): çizgi tam genişlikte olmalı; global `before:w-px` kullanılmaz.
        'aria-[orientation=horizontal]:before:left-0 aria-[orientation=horizontal]:before:right-0 aria-[orientation=horizontal]:before:h-px aria-[orientation=horizontal]:before:top-0 aria-[orientation=horizontal]:before:bottom-auto',
        'aria-[orientation=horizontal]:before:w-full aria-[orientation=horizontal]:before:translate-y-0 aria-[orientation=horizontal]:before:translate-x-0',
