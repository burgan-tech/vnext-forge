...
export function Pagination({
  ...
  // Sync go-to input when page changes externally
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="ml-2 flex items-center gap-1.5">
          ...
          <input
            ...
            className="h-8 w-14 rounded-md border border-border bg-background px-2 text-center text-xs font-mono text-foreground focus:outline-none focus:ring-1 focus:ring-primary [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
          />
        </div>
      </div>
